...
public class LoggingAspectProperties {
     ...
     */
    static final String SPRING_AOP_LOGGING_PREFIX = "saint.gobain.aop.logging";
    ...
    /**
     * Defines whether the SaintGobain logging is enabled or not (default: disabled).
     */
    private boolean enabled = false;

    /**
     * Defines the list of packages to enabled Saint-Gobain logging.
     */
